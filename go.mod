module github.com/init-pkg/nova-template
...
require (
	...
	github.com/init-pkg/nova v0.0.0-20250706062546-0fde85470914
	github.com/init-pkg/nova-kits v0.0.0-20250518152713-6f0953075fb1
